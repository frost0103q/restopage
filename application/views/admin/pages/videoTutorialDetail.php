...
<div class="card o-hidden border-0 shadow-lg my-5">
    <div class="card-header py-3 d-flex justify-content-between title-bar">
        <h1 class="h4 text-gray-900 mb-0"><?= $this->lang->line("Video")?> <?= $this->lang->line("Tutorial")?>  <?= $this->lang->line("Detail")?></h1>
        <div class="lang-bar">
                    ...
                    <form id="videoTutorialsForm">
                        <div class="row mb-4">
                            <div class="col-md-4 update-video text-center">
                                <input type="hidden" class="video_id" name="video_id" value="<?= isset($video_id) ? $video_id : "0" ?>"/>
                                <?php
                                ...
                                ?>
                                <video width="100%" height="auto" controls class="old_video">
                                    <source src="<?= $video_url?>">
                                </video>
                                <div class="new_video_upload hide-field">
                                    <input type="file" class="dropify" name="video" />
                                </div>
                                <div class="new_upload_video_section mt-3">
                                    <label for="is_upload_new_video"><?=$this->lang->line("Upload New Video")?></label>
                                    <input type="checkbox" class="is_upload_new_video ml-3" id ="is_upload_new_video" name="is_upload_new_video" value="on" />
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="input-group english-field hide-field video_description-editor lang-field">
                                    ...
                                    <textarea class="summernote form-control" name="video_description_english" data-plugin-options='{ "height": 200}'><?= isset($video_tutorial) ? $video_tutorial->video_description_english : ""?></textarea>
                                </div>
                                <div class="input-group french-field hide-field video_description-editor lang-field">
                                    ...
                                    <textarea class="summernote form-control" name="video_description_french"><?= isset($video_tutorial) ? $video_tutorial->video_description_french : ""?></textarea>
                                </div>
                                <div class="input-group germany-field hide-field video_description-editor lang-field">
                                    ...
                                    <textarea class="summernote form-control" name="video_description_germany" ><?= isset($video_tutorial) ? $video_tutorial->video_description_germany : ""?></textarea>
                                </div>
                            </div>
                        </div>
                        <div>
