                                    ...
                                    <div class="form-group">
                                        <section class="imprint-section">
                                            ...
                                            <div class="input-group french-field hide-field lang-field">
                                                ...
                                                <textarea class=" summernote form-control" name="imprint_page_content_french"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->imprint_page_content_french : ""?></textarea>
                                            </div>
                                            <div class="input-group english-field hide-field lang-field">
                                                ...
                                                <textarea class=" summernote form-control" name="imprint_page_content_english"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->imprint_page_content_english : ""?></textarea>
                                            </div>
                                            <div class="input-group germany-field hide-field lang-field">
                                                ...
                                                <textarea class=" summernote form-control" name="imprint_page_content_germany"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->imprint_page_content_germany : ""?></textarea>
                                            </div>
                                        </section>
                                        <section class="data-protect-section mt-5">
                                            ...
                                            <div class="input-group french-field hide-field lang-field">
                                                ...
                                                <textarea class=" summernote form-control" name="data_protection_page_content_french"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->data_protection_page_content_french : ""?></textarea>
                                            </div>
                                            <div class="input-group english-field hide-field lang-field">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><img class="img-profile rounded-circle active-flag" src="<?= base_url('assets/flags/en-flag.png')?>" ></span>
                                                </div>
                                                <textarea class=" summernote form-control" name="data_protection_page_content_english"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->data_protection_page_content_english : ""?></textarea>
                                            </div>
                                            <div class="input-group germany-field hide-field lang-field">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><img class="img-profile rounded-circle active-flag" src="<?= base_url('assets/flags/ge-flag.png')?>" ></span>
                                                </div>
                                                <textarea class=" summernote form-control" name="data_protection_page_content_germany"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->data_protection_page_content_germany : ""?></textarea>
                                            </div>
                                        </section>
                                        <section class="tc-section mt-5">
                                            ...
                                            <div class="input-group french-field hide-field lang-field">
                                                ...
                                                <textarea class=" summernote form-control" name="tc_page_content_french"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->tc_page_content_french : ""?></textarea>
                                            </div>
                                            <div class="input-group english-field hide-field lang-field">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><img class="img-profile rounded-circle active-flag" src="<?= base_url('assets/flags/en-flag.png')?>" ></span>
                                                </div>
                                                <textarea class=" summernote form-control" name="tc_page_content_english"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->tc_page_content_english : ""?></textarea>
                                            </div>
                                            <div class="input-group germany-field hide-field lang-field">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><img class="img-profile rounded-circle active-flag" src="<?= base_url('assets/flags/ge-flag.png')?>" ></span>
                                                </div>
                                                <textarea class=" summernote form-control" name="tc_page_content_germany"  placeholder = "" ><?=isset($legal_page_settings) ? $legal_page_settings->tc_page_content_germany : ""?></textarea>
                                            </div>
                                        </section>
                                    </div>
